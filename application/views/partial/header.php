...
<html>
	<head>
		<title><?php echo $this->config->item('company').' -- '.lang('common_powered_by').' Galaxy Studio' ?></title>
		<meta charset="UTF-8" />
	...
	<body data-color="grey" class="flat">
		...
		$sidebar_class = "";
		$sales_content_class = "";
		if ($this->router->fetch_class() == "sales" || $this->router->fetch_class() == "receivings" || ($this->uri->segment(1)== "expenses" && $this->uri->segment(2)== "receipt") || ($this->uri->segment(1)== "expenses" && $this->uri->segment(2)== "cash_receipt")) {
