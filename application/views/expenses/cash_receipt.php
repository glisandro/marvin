...
<div id="receipt_wrapper" class="receipt_<?php echo $this->config->item('receipt_text_size');?>">
	<div id="receipt_header">
		...
		<?php } ?>
		<div id="sale_time"><?php echo $cash_time ?></div>
		<div class="pull-right"><button class="btn btn-primary text-white hidden-print" id="new_sale_button_1" onclick="window.location='<?php echo site_url('expenses/cash/-1/3'); ?>'" > <?php echo lang('cash_withdrawal'); ?> </button></div>
	</div>
	...
	<?php 
	if ($this->Employee->has_module_action_permission('expenses', 'cash_withdrawal', $this->Employee->get_logged_in_employee_info()->person_id)){

	echo form_open("expenses/cash/".$cash_id."/3",array('id'=>'expenses_change_form')); ?>
