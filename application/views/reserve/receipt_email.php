...
<body>
	...
	?>
	<th style="width:16%;<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>"><?php echo lang('reserve_total'); ?></th>
	</tr>
	<?php
	foreach(array_reverse($cart, true) as $line=>$room)
	{
	?>
		...
		?>
		<td style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo to_currency($room['price']*$room['quantity']-$room['price']*$room['quantity']*$room['discount']/100); ?></td>
		</tr>

	    <tr>
	    <td colspan="2" align="center"><?php echo $room['description']; ?></td>
		<td colspan="2" ><?php echo isset($room['serialnumber']) ? $room['serialnumber'] : ''; ?></td>
	...
	?>
	<tr>
	<td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>;border-top:2px solid #000000;'><?php echo lang('reserve_sub_total'); ?></td>
	...
	<tr>
	<td colspan="4" style='<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>'><?php echo lang('reserve_total'); ?></td>
    ...
    <?php
		...
		?>
			...
			?>
			<td colspan="2" style="<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>"><b><?php echo $this->config->item('round_cash_on_sales') && $payment['payment_type'] == lang('reserve_cash') ?  to_currency(round_to_nearest_05($payment['payment_amount'])) : to_currency($payment['payment_amount']); ?> </b> </td>
		    </tr>
		<?php
		}
		?>
	...
	<tr>
		<td colspan="2" style="<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>"><?php echo lang('reserve_giftcard_balance'); ?></td>
