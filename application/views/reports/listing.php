		...
		<div class="panel">
			<div class="panel-body">
				<div class="list-group parent-list">
					...
					{
					?>
						<a href="#" class="list-group-item" id="expenses"><i class="fa fa-money"></i>	<?php echo lang('reports_expenses'); ?></a>
					<?php } ?>
				</div>
			</div>
		</div> <!-- /panel -->
		...
		<div class="panel">
			...
			<h3 class="page-header text-info">&laquo; <?php echo lang('reports_make_a_selection')?></h3>
				...
				<div class="list-group sales hidden">
					...
					<a class="list-group-item" href="<?php echo site_url('reports/detailed_sales_customer');?>" ><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports_customer'); ?></a>
					<a class="list-group-item" href="<?php echo site_url('reports/detailed_sales_area');?>" ><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports_area'); ?></a>
					<a class="list-group-item" href="<?php echo site_url('reports/summary_count_items');?>" ><i class="fa fa-building-o"></i> <?php echo lang('reports_count_items_reports'); ?></a>
				</div>
				...
				<div class="list-group items hidden">
					...
					<a href="<?php echo site_url('reports/detailed_items_less_sales');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_items_less_sales'); ?></a>
				</div>
				...
				<div class="list-group expenses hidden">
					<a href="<?php echo site_url('reports/graphical_summary_expenses_category');?>" class="list-group-item"><i class="fa fa-bar-chart-o"></i> <?php echo lang('reports_graphical_category_reports'); ?></a>
					<a href="<?php echo site_url('reports/detailed_expenses_category');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_expenses_category_reports'); ?></a>
					<a href="<?php echo site_url('reports/graphical_summary_expenses_location');?>" class="list-group-item"><i class="fa fa-bar-chart-o"></i> <?php echo lang('reports_graphical_location_reports'); ?></a>
					<a href="<?php echo site_url('reports/detailed_expenses_location');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_expenses_location_reports'); ?></a>
				</div>
			</div>
		</div> <!-- /panel -->
	</div>
