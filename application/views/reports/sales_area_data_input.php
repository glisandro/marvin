				...
				<div class="widget-content nopadding">
					...
					<form  class="form-horizontal form-horizontal-mobiles">
						...
						<div class="form-group">
							...
							<?php echo form_label($specific_input_name2.' :', 'specific_input_name_label', array('class'=>'col-sm-1 col-md-1 col-lg-1 control-label ')); ?> 
							<div class="col-sm-4 col-md-4 col-lg-4">
								
								<?php if (isset($search_suggestion_url2)) {?>
									<?php echo form_input(array(
										'name'=>'specific_input_data2',
										'id'=>'specific_input_data2',
										'size'=>'10',
										'value'=>''));
									?>									
								<?php } else { ?>
									<?php echo form_dropdown('specific_input_data2',$specific_input_data2, '', 'id="specific_input_data2" class="input-medium"'); ?>
								<?php } ?>
							</div>
						</div>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		...
		$("#generate_report").click(function()
		{
			...
			var specific_id2 = $("#specific_input_data2").val() ? $("#specific_input_data2").val() : -1;
			...
			{
				window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + specific_id+ '/' + specific_id2 + '/' + sale_type + '/'  + export_excel;
			}
			else
			{
				...
				window.location = window.location+'/'+start_date + '/'+ end_date + '/' + specific_id+ '/' + specific_id2 + '/' + sale_type + '/' +  export_excel;
			}
		});
